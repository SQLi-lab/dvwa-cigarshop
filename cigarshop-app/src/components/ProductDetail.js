        ...
        <Container style={{ marginTop: '20px', fontFamily: 'Arial, sans-serif' }}>
            <Paper style={{ padding: '20px', marginBottom: '20px', display: 'flex', gap: '20px' }}>
                ...
                <div>
                    ...
                    <Typography variant="body1" style={{ marginBottom: '10px', color: '#6B3A0A' }}>
                        Категория: {product.category || 'Не указано'}
                    </Typography>
                    <Typography variant="body1" style={{ marginBottom: '10px', color: '#6B3A0A' }}>
                        В наличии: {product.stock > 0 ? `${product.stock} шт.` : 'Нет в наличии'}
                    </Typography>
                    <Typography variant="body1" style={{ marginBottom: '10px', color: '#8B4513', fontWeight: 'bold' }}>
                        Цена: {product.price} руб.
                    </Typography>
                    <Button
                        variant="contained"
                        style={{ backgroundColor: '#8B4513', color: '#fff', marginTop: '20px' }}
            ...
            <Paper style={{ padding: '20px' }}>
                ...
                {reviews.length > 0 ? (
                    reviews.map((review, index) => (
                        ...
                        >
                            <Typography style={{ color: '#6B3A0A' }}>Автор: {review.username || 'guest'}</Typography>
                            <Typography style={{ marginTop: '5px', color: '#6B3A0A' }}>{review.review_text}</Typography>
                        </Paper>
                    ))
                ) : (
                ...
                <Button
                    variant="contained"
                    style={{ backgroundColor: '#8B4513', color: '#fff', marginTop: '10px' }}
