    ...
    return (
        <Container style={{ marginTop: '20px', fontFamily: 'Arial, sans-serif' }}>
            <Paper elevation={3} style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
                <Typography variant="h5" style={{ textAlign: 'center', marginBottom: '20px', color: '#8B4513' }}>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={3} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <img
                                ...
                                style={{ borderRadius: '50%', width: '150px', height: '150px', border: '2px solid #8B4513' }}
                            />
                        </Grid>
                        <Grid item xs={12} md={9}>
                            <Typography variant="h6" style={{ color: '#8B4513' }}>{userData.name}</Typography>
                ...
                <Paper elevation={2} style={{ padding: '20px', marginBottom: '20px' }}>
                    <Typography variant="h6" style={{ marginBottom: '10px', color: '#8B4513' }}>
                        Избранные товары:
                    </Typography>
                    {favorites.length === 0 ? (
                        ...
                        favorites.map((fav, index) => (
                            ...
                            >
                                <Typography>{fav.cigar_name || 'Не указано'}</Typography>
                            </Paper>
                        ))
                    )}
                </Paper>
                    ...
                    {reviews.length === 0 ? (
                        ...
                        <>
                            {paginatedReviews.map((review, index) => (
                                ...
                                >
                                    <Typography>Товар: {review.cigar_name || 'Не указано'}</Typography>
